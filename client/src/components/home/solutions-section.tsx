      ...
      <div className="lg:w-[80%] xl:w-[1000px]">
        <div className="flex w-[374px] flex-col gap-12">
          <div className="flex flex-col gap-6">
            <div className="text-center font-serif text-base uppercase leading-[14px] tracking-wider text-gray-500 lg:text-left lg:text-sm">
              Solutions for soil carbon experts
            </div>
            <div className="flex flex-col items-center gap-8">
              <h2 className="font-serif text-2xl font-semibold text-slate-700 lg:text-3xl">
                Hear from Impact4Soil users
              </h2>
              <div className="h-2 w-20 self-start rounded-lg bg-yellow-500" />
            </div>
          </div>
          <div className="px-4 text-gray-500 lg:w-[374px] lg:px-0">
            <span>
