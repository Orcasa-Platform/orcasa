...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_SURVEY_TOOLTIP_EXPANDED_UNTIL: z.string().refine((value) => {
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_SURVEY_TOOLTIP_EXPANDED_UNTIL:
      process.env.NEXT_PUBLIC_SURVEY_TOOLTIP_EXPANDED_UNTIL,
  },
});
