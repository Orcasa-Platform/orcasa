...
const PopupContainer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-h-[49vh] space-y-2.5 overflow-y-auto overflow-x-hidden p-2.5 pr-8 pt-4 text-slate-800 shadow-[0_20px_15px_rgba(0,0,0,0.1)]">
        {layersInteractive.map((id) => (
